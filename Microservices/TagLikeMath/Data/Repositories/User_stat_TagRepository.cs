...
namespace TagLikeMath.Data.Repositories
{
    internal class User_stat_TagRepository : IUser_stat_TagRepository
    {
        ...
        {
            return _context.User_stat_Tag.Where(t => t.user_id == user_id && t.tag_id == tag_id).FirstOrDefault();
        }

        public IQueryable<User_stat_Tag> GetAll()
        {
            return _context.User_stat_Tag.AsQueryable();
        }
        public IQueryable<User_stat_Tag> GetUser_stat_TagByUserId(int user_id)
        {
            return _context.User_stat_Tag.Where(t => t.user_id == user_id);
        }
        //-----------------------------------------
        ...
        {
            _context.User_stat_Tag.Remove(entity);
        }
        //-----------------------------------------
