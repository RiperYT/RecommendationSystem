...
{
    internal class LikeStaticService : ILikeStaticService
    {
        ...
        public LikeStaticService(IPostStatisticService postStatisticService,
        ...
        public void LikeUserPost(int user_id, int post_id)
        {
            ...
            var userStandardTagsQ = _user_Standard_TagRepository.GetUser_standard_TagByUserId(user_id);
            var postStandardTagsQ = _post_Standard_TagRepository.GetPost_standard_TagByPostId(post_id);
            ...
            _userStatisticService.UpdateStats(user_id, userTags, userNewTags);
            _postStatisticService.UpdateStats(post_id, postTags, postNewTags);
        }
    }
}
